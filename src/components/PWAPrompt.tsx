...
export function PWAPrompt({ isOpen, onClose }: PWAPromptProps) {
  ...
  return (
    <div className="fixed bottom-20 right-4 left-4 md:left-auto z-50 print:hidden animate-in slide-in-from-bottom-4 duration-300">
      <div className="bg-white rounded-lg shadow-lg border border-slate-200 px-4 py-3 flex items-center gap-3 md:min-w-[320px]">
